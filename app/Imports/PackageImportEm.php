...
class PackageImportEm implements ToModel, WithValidation, WithHeadingRow
{
    ...
    public function rules(): array
    {
        return [
            ...
            'shipper_cin' => ['email'],
            'shipper_email' => [''],
            'shipper_city' => ['required', 'exists:cities,localite'],
    ...
    public function model(array $row)
    {
        ...
        return new Package([
            ...
            'CustomerEmail' => isset($row['customer_email']) ? $row['customer_email'] : null,
            'CustomerCin' => isset($row['customer_cin']) ? $row['customer_cin'] : null,
            ...
            'ShipperCin' => isset($row['shipper_cin']) ? $row['shipper_cin'] : null,
            'ShipperEmail' => isset($row['shipper_email']) ? $row['shipper_email'] : null,
            'ShipperCity' => City::where('localite', $row['shipper_city'])->first()->id,
