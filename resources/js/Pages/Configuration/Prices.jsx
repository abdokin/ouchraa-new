...
const Table = ({ map, set, setAll, remove, reset, prices }) => {
    ...
    const pricesID = prices.map((it) => it.id);
        ...
        <div className="row">
            ...
            <div className="col-sm-12 min-vh-100">
                        ...
                        {prices.map((it, index) => {
                            return (
                                <tr role="row" className="odd">
                                    ...
                                    <td>
                                        <strong>
                                            {it.first_mile.ShipmentProviderName}
                                        </strong>
                                        <br />
                                        <small className="text-muted">
                                            <i className="fas fa-paper-plane"></i>{" "}
                                            {it.first_mile.city.localite}
                                        </small>
                                    </td>
                                    <td>
                                        <strong>
                                            {
                                                it.last_mile?.shipment_provider
                                    ...
                                    <td>
                                        <strong>2023-01-26 12:26:02</strong>
                                        <br />
                                        <small className="text-muted">
                ...
                <div
                    ...
                    style={{ display: prices.length > 0 ? "none" : "block" }}
                >
                    {/* Processing... */}
                    No Data
                </div>
...
const Head = ({ openCreate, selected, openUpload }) => {
    const Enable = (value) => {
