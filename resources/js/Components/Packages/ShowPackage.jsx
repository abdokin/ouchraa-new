...
export function ShowPackage({ packageCurrent }) {
    const [packageData, setPackageData] = useState(1);
    ...
    // },[])
    console.log("History", packageCurrent.history);
    return (
        <>
                        ...
                        <div className="tab-content">
                            ...
                            >
                                ...
                                >
                                    <dl id="ShippingInfo" className="row">
                                        ...
                                        <dd className="col-sm-7">
                                            <strong>{packageCurrent.shipping_method.WorkflowName}</strong>
                                        </dd>
                                        <dt className="col-sm-5">
                                        ...
                                        <dd className="col-sm-7">
                                            <strong>
                                                {packageCurrent.AmountToCollect}{" "}
                                                Dhs
                                            </strong>
                                        </dd>
                                        <dt className="col-sm-5">
                            ...
                            >
                                ...
                                <p className="mb-0">
                                    ...
                                    molestiae, dolorum iusto iste in quas
                                    ratione, iure quisquam maiores consectetur?
                                    Rem nihil vero nisi voluptatibus hic
                                    corrupti!
                                </p>
                            </div>
                            <div
